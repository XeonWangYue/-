/****************************************************************************
** Meta object code from reading C++ file 'mymain.h'
**
...
#include "../../../src/myWordBook/mymain.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'mymain.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyMain_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject MyMain::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_MyMain.data,
    qt_meta_data_MyMain,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *MyMain::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyMain.stringdata0))
